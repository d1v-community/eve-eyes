    ...
    <OperationsShell>
      <div className="flex min-w-0 flex-col gap-6">
        <section className="grid gap-6 xl:grid-cols-[0.92fr_1.08fr]">
          <div className="min-w-0 rounded-[2rem] border border-slate-200/70 bg-white/85 p-4 sm:p-6 shadow-[0_18px_60px_rgba(15,23,42,0.08)] backdrop-blur dark:border-slate-800 dark:bg-slate-950/75">
            ...
            {featuredShipResult?.data ? (
              <div className="space-y-5">
                <div className="min-w-0">
                  ...
                  <h2 className="mt-3 break-words text-2xl font-semibold text-slate-950 sm:text-3xl dark:text-white">
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {shipsResult.data?.data.map((ship) => (
            <article
              key={ship.id}
              className="min-w-0 rounded-[1.75rem] border border-slate-200/70 bg-white/85 p-4 sm:p-5 shadow-[0_18px_60px_rgba(15,23,42,0.08)] dark:border-slate-800 dark:bg-slate-950/75"
            >
              ...
              <p className="mt-4 break-words text-sm leading-7 text-slate-600 dark:text-slate-300">
                {ship.description}
              </p>
            </article>
          ))}
