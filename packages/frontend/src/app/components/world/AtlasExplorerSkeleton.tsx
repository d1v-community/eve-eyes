  ...
  return (
    <div className="relative overflow-hidden rounded-[2.2rem] border border-stone-300/70 bg-[linear-gradient(135deg,#f6efe2_0%,#efe4d3_38%,#d9e1e7_100%)] shadow-[0_32px_120px_rgba(40,32,20,0.14)] dark:border-stone-800 dark:bg-[linear-gradient(135deg,#07111c_0%,#0b1c2d_42%,#111827_100%)]">
      ...
      <div className="relative grid gap-5 p-3 lg:p-4 xl:grid-cols-[22rem_minmax(0,1fr)_20rem]">
        ...
        <section className="min-w-0 rounded-[2rem] border border-stone-300/70 bg-[linear-gradient(180deg,rgba(255,252,245,0.88),rgba(240,232,221,0.74))] p-3 shadow-[0_18px_50px_rgba(72,56,32,0.10)] dark:border-slate-800 dark:bg-slate-950/55">
          <div className="mb-3 rounded-[1.6rem] border border-stone-300/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.72),rgba(248,245,238,0.66))] px-4 py-4 dark:border-slate-800 dark:bg-slate-950/55">
        ...
        <section className="flex flex-col gap-4 rounded-[1.9rem] border border-stone-300/70 bg-[linear-gradient(180deg,rgba(252,249,244,0.86),rgba(243,237,228,0.74))] p-4 shadow-[0_18px_50px_rgba(72,56,32,0.08)] dark:border-slate-800 dark:bg-slate-950/60">
